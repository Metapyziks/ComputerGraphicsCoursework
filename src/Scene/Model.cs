...
namespace ComputerGraphicsCoursework.Scene
{
        ...
        IDisposable
    {
        ...
        /// <summary>
        /// Draw all face groups in the model using a given model shader.
        /// </summary>
        /// <param name="shader">ModelShader to use to draw each face</param>
        ...
        /// <summary>
        /// Draw a specified set of face groups in the model using a given model shader.
        /// </summary>
        /// <param name="shader">ModelShader to use to draw each face</param>
        /// <param name="facegroups">Set of face groups to draw</param>
        public void Render(ModelShader shader, params FaceGroup[] facegroups)
        {
            _vb.Begin(shader);
            foreach (var facegroup in facegroups) {
                // Render a range of vertices from the vertex buffer
        ...
        /// <summary>
        /// Draw all face groups in the model using a given depth clip shader.
        /// </summary>
        /// <param name="shader">DepthClipShader to use to draw each face</param>
        ...
        /// <summary>
        /// Draw a specified set of face groups in the model using a given depth clip shader.
        /// </summary>
        /// <param name="shader">DepthClipShader to use to draw each face</param>
        /// <param name="facegroups">Set of face groups to draw</param>
